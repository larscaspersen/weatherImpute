#' Calculate the refined inxed of agreement
#' 
#' This function calculates the refined index of agreement, which is an 
#' evaluation metric especially suited for precipitation occurence in aerid 
#' regions.
#' 
#' The refined index of agreemen can range from -1 to 1, where a value close to one indicates good
#' model performance to predict precipitation occurence. It is said to approach
...
#' @examples calc_d_index(predicted = c(rep(0,5), rep(1, 5)), 
